...
import java.io.*;
import java.util.*;
//Your job is to write a program that will examine a list of beginning and ending times for N (1 <= N <= 5000) 
//farmers milking N cows and compute longest time interval when a cow were being milked and during which no cows were being milked.
//This is the code for the problem of Milking Cows in USACO
